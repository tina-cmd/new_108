<template>
    <div>
        ...
        <div
            class="overflow-y-auto max-h-full border border-gray-300 rounded-md"
        >
        ...
        <div v-if="isEditing" class="mt-4 p-4 border border-gray-300 rounded-md bg-gray-50">
            ...
            <form @submit.prevent="updateBook">
                ...
                <div class="text-center">
                    ...
                    <button @click="cancelEdit" type="button" class="ml-2 bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-600">
                        Cancel
                    </button>
                </div>
            </form>
